...
def readColmapSceneInfo(path, images, eval, llffhold=10):
    ...
    if not os.path.exists(bin_path):
        raise ValueError("No valid points3D.bin found in the path!!")
...
def readCamerasFromTransformsCity(
    ...
    with open(os.path.join(path, transformsfile)) as json_file:
        ...
        for idx, frame in enumerate(frames):
            ...
            #cam_name = os.path.join(path, "sparse/small_city/"+ frame["file_path"])
            cam_name = "/root/autodl-tmp/datasets/matrixcity/aerial"+ frame["file_path"]
...
def readCityInfo(
    ...
    smallcity_Path = "/root/autodl-tmp/datasets/matrixcity/aerial/pose/block_all/"
    train_json_path = smallcity_Path + "transforms_train.json"
    test_json_path = smallcity_Path + "transforms_test.json"
    print(
    ...
    ply_path = "/root/autodl-tmp/datasets/matrixcity/point_cloud_ds20/aerial/Block_all.ply"
