...
from scene.dataset_readers import sceneLoadTypeCallbacks, fetchPly, storePly
...
class Scene:
    ...
    def uptateGaussians(self, gaussians: GaussianModel):
        self.gaussians = gaussians
...
class SceneDataset:
    def __init__(self, cameras):
        ...
        self.camera_size = len(self.cameras) if self.cameras is not None else 0
