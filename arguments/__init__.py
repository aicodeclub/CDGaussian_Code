...
class AuxiliaryParams(ParamGroup):
    def __init__(self, parser, sentinel=False):
        ...
        self.test_iterations = [7_000, 10_000, 15_000, 20_000, 25_000, 30_000]
        self.save_iterations = [7_000, 10_000, 15_000, 20_000, 25_000, 30_000]
        self.quiet = False
        self.checkpoint_iterations = []
        self.start_checkpoint = ""
        self.auto_start_checkpoint = False
        self.log_folder = "/root/autodl-tmp/result"
...
class ModelParams(ParamGroup):
    def __init__(self, parser, sentinel=False):
        self.sh_degree = 3
        self._source_path = ""
        self._model_path = "/root/autodl-tmp/output/"
        self._images = "images"
